...
import CoeffecientData as aero_table
#--------------------------------------
"""LIFT EQUATIONS"""
#--------------------------------------
...
#--------------------------------------
CL=CL_0+(CL_alpha*find_alpha.alpha)+(CL_delta*find_alpha.delta_rad)
CM=CM_0+(CM_alpha*find_alpha.alpha)+(CM_delta*find_alpha.delta_rad)
CD=CD_0 +(CD_k*CL**2)
"""these alpha values likely need to be changed to take the alpha taken from 
the 3DOF equations"""